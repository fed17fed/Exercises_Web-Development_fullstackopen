  ...
  return (
    <div>
      <h1> <Header course={course} /></h1>
        ...
        <Content part={content[0].part1} exercises={content[0].exercises1} />
      
        <Content part={content[1].part2} exercises={content[1].exercises2} />
     
        <Content part={content[2].part3} exercises={content[2].exercises3} />
